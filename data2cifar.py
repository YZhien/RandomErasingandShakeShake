...
def get_loader(batch_size, num_workers, use_gpu):
    ...
    print("load flowers")
    train_dataset_dir = '/home1/zhienyu/ondemand/data/sys/myjobs/projects/default/1/567_shake_RE/Vegetable_Images/train'
    test_dataset_dir = '/home1/zhienyu/ondemand/data/sys/myjobs/projects/default/1/567_shake_RE/Vegetable_Images/test'
